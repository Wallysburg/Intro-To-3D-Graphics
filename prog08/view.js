...
window.onload = function init()
{
    ...
    picture = new Picture(gl, new PV(-1, 1, 0, true), new PV(1, 0, 0, false), new PV(0, -1, 0, false), 2, 2);
...
function render() {
    ...
    gl.uniformMatrix4fv(model2clipLoc, false,
                        world2clip.times(picture.picture2world).flatten());
    ...
    var model2picture = gl.getUniformLocation(program, "model2picture");
    gl.uniformMatrix4fv(model2picture, false, picture.world2picture.times(model2world).flatten());
